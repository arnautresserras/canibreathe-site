const TRANSLATIONS = {
  ca: {
    ...
    'feat2.desc':  'Dades reals d\'estació per a Catalunya i les Illes Balears — incloent-hi la distància a l\'estació de seguiment més propera — amb cobertura global gràcies a Open-Meteo. Fes seguiment de diverses ciutats alhora.',
    ...
    'feat5.desc':  'Consulta les finestres de temporada típiques i els mesos de pic per a cada al·lergen a la Guia integrada — amb etiquetes de font (PIA o EAN) per al·lergen i dades regionals que omplen els buits.',
    ...
    'feat7.title': 'Condicions d\'avui d\'un cop d\'ull',
    'feat7.desc':  'Una targeta plegable mostra el temps i l\'Índex de Qualitat de l\'Aire de la UE un al costat de l\'altre — màxima, mínima, vent, precipitació i una barra AQI de 6 bandes, sense sortir de la previsió.',
    'feat8.title': 'Planifica amb confiança',
    'feat8.desc':  'La pestanya Planifica reuneix dues eines en un sol lloc: la millor hora per sortir avui (gràfic d\'al·lèrgens hora per hora amb icones del temps) i el calendari de temporada per a cada localització que segueixes.',
    'feat9.title': 'Entén per què els nivells són alts',
    'feat9.desc':  'L\'app mostra el motiu del nivell d\'avui — pluja en camí, condicions seques i ventoses, o un pic de temporada — perquè sempre sàpigues amb què t\'enfrontes.',
    'feat10.title': 'Funciona sense connexió',
    'feat10.desc':  'L\'app mostra l\'última previsió emmagatzemada amb una marca de temps quan perds la connexió a internet.',
  ...
  en: {
    ...
    'feat2.desc':  'Real station data for Catalonia and the Balearic Islands — including the distance to your nearest monitoring station — plus global coverage via Open-Meteo. Track multiple cities at once.',
    ...
    'feat5.desc':  'Browse typical season windows and peak months for each allergen in the built-in Guide — with per-allergen source labels (PIA or EAN) and regional data filling any gaps.',
    ...
    'feat7.title': 'Today\'s conditions at a glance',
    'feat7.desc':  'A collapsible card shows today\'s weather and EU Air Quality Index side-by-side — high, low, wind, precipitation and a 6-band AQI bar, all without leaving the forecast.',
    'feat8.title': 'Plan ahead with confidence',
    'feat8.desc':  'The dedicated Plan tab brings together two forward-looking tools: the best time to go out today (an hour-by-hour allergen chart with weather icons) and the full season calendar for every location you track.',
    'feat9.title': 'Understand why levels are high',
    'feat9.desc':  'The app surfaces the reason behind today\'s level — rain on the way, dry and windy conditions, or a seasonal peak — so you always know what you\'re dealing with.',
    'feat10.title': 'Works offline',
    'feat10.desc':  'The app shows your last cached forecast with a timestamp when you lose connectivity.',
  ...
  es: {
    ...
    'feat2.desc':  'Datos reales de estación para Cataluña y las Islas Baleares — incluyendo la distancia a la estación de seguimiento más cercana — con cobertura global gracias a Open-Meteo. Sigue varias ciudades a la vez.',
    ...
    'feat5.desc':  'Consulta las ventanas de temporada típicas y los meses pico para cada alérgeno en la Guía integrada — con etiquetas de fuente (PIA o EAN) por alérgeno y datos regionales que llenan los vacíos.',
    ...
    'feat7.title': 'Las condiciones de hoy de un vistazo',
    'feat7.desc':  'Una tarjeta plegable muestra el tiempo y el Índice de Calidad del Aire de la UE lado a lado — máxima, mínima, viento, precipitación y una barra AQI de 6 bandas, sin salir de la previsión.',
    'feat8.title': 'Planifica con confianza',
    'feat8.desc':  'La pestaña Plan reúne dos herramientas en un solo lugar: la mejor hora para salir hoy (un gráfico de alérgenos hora a hora con iconos del tiempo) y el calendario de temporada para cada ubicación que sigues.',
    'feat9.title': 'Entiende por qué los niveles son altos',
    'feat9.desc':  'La app muestra la razón detrás del nivel de hoy — lluvia en camino, condiciones secas y ventosas, o un pico de temporada — para que siempre sepas a qué te enfrentas.',
    'feat10.title': 'Funciona sin conexión',
    'feat10.desc':  'La app muestra tu última previsión almacenada con una marca de tiempo cuando pierdes la conectividad.',
  ...
  fr: {
    ...
    'feat2.desc':  'Données de stations réelles pour la Catalogne et les Îles Baléares — dont la distance à votre station de surveillance la plus proche — plus une couverture mondiale via Open-Meteo. Suivez plusieurs villes à la fois.',
    ...
    'feat5.desc':  'Consultez les fenêtres de saison typiques et les mois de pic pour chaque allergène dans le Guide intégré — avec des étiquettes de source (PIA ou EAN) par allergène et des données régionales comblant les lacunes.',
    ...
    'feat7.title': 'Les conditions du jour en un coup d\'œil',
    'feat7.desc':  'Une carte repliable affiche la météo et l\'Indice de Qualité de l\'Air de l\'UE côte à côte — max, min, vent, précipitations et une barre AQI à 6 niveaux, sans quitter la prévision.',
    'feat8.title': 'Planifiez en toute confiance',
    'feat8.desc':  'L\'onglet Plan rassemble deux outils en un seul endroit : la meilleure heure pour sortir aujourd\'hui (un graphique allergène heure par heure avec des icônes météo) et le calendrier des saisons pour chaque lieu suivi.',
    'feat9.title': 'Comprenez pourquoi les niveaux sont élevés',
    'feat9.desc':  'L\'app affiche la raison du niveau du jour — pluie à venir, conditions sèches et venteuses, ou pic saisonnier — pour que vous sachiez toujours à quoi vous en tenir.',
    'feat10.title': 'Fonctionne hors connexion',
    'feat10.desc':  'L\'app affiche votre dernière prévision mise en cache avec un horodatage en cas de perte de connexion.',
  ...
  pt: {
    ...
    'feat2.desc':  'Dados reais de estações para a Catalunha e as Ilhas Baleares — incluindo a distância à estação de monitorização mais próxima — mais cobertura global via Open-Meteo. Segue várias cidades ao mesmo tempo.',
    ...
    'feat5.desc':  'Consulta as janelas de época típicas e os meses de pico para cada alergénio no Guia integrado — com etiquetas de fonte (PIA ou EAN) por alergénio e dados regionais a preencher as lacunas.',
    ...
    'feat7.title': 'As condições de hoje de relance',
    'feat7.desc':  'Um cartão recolhível mostra o tempo e o Índice de Qualidade do Ar da UE lado a lado — máxima, mínima, vento, precipitação e uma barra AQI de 6 bandas, tudo sem sair da previsão.',
    'feat8.title': 'Planeia com confiança',
    'feat8.desc':  'O separador Planear reúne duas ferramentas num só lugar: a melhor hora para sair hoje (um gráfico de alergénios hora a hora com ícones do tempo) e o calendário de época para cada localização que segues.',
    'feat9.title': 'Percebe por que os níveis estão altos',
    'feat9.desc':  'A app mostra a razão por trás do nível de hoje — chuva a caminho, condições secas e ventosas, ou um pico de época — para que saibas sempre com o que estás a lidar.',
    'feat10.title': 'Funciona offline',
    'feat10.desc':  'A app mostra a tua última previsão em cache com uma marca de tempo quando perdes a ligação.',
  ...
  it: {
    ...
    'feat2.desc':  'Dati da stazioni reali per la Catalogna e le Isole Baleari — inclusa la distanza dalla stazione di monitoraggio più vicina — più copertura globale tramite Open-Meteo. Monitora più città contemporaneamente.',
    ...
    'feat5.desc':  'Sfoglia le finestre di stagione tipiche e i mesi di picco per ogni allergene nella Guida integrata — con etichette di fonte (PIA o EAN) per allergene e dati regionali che colmano eventuali lacune.',
    ...
    'feat7.title': 'Le condizioni di oggi in un colpo d\'occhio',
    'feat7.desc':  'Una scheda comprimibile mostra il meteo e l\'Indice di Qualità dell\'Aria dell\'UE affiancati — massima, minima, vento, precipitazioni e una barra AQI a 6 livelli, senza uscire dalla previsione.',
    'feat8.title': 'Pianifica in tutta sicurezza',
    'feat8.desc':  'La scheda Piano riunisce due strumenti in un unico posto: l\'orario migliore per uscire oggi (un grafico degli allergeni ora per ora con icone meteo) e il calendario delle stagioni per ogni località che segui.',
    'feat9.title': 'Capisci perché i livelli sono alti',
    'feat9.desc':  'L\'app mostra il motivo dietro al livello odierno — pioggia in arrivo, condizioni secche e ventose, o un picco stagionale — così sai sempre con cosa hai a che fare.',
    'feat10.title': 'Funziona offline',
    'feat10.desc':  'L\'app mostra l\'ultima previsione memorizzata con un indicatore orario quando perdi la connessione.',
  ...
  de: {
    ...
    'feat2.desc':  'Echte Stationsdaten für Katalonien und die Balearischen Inseln — einschließlich der Entfernung zur nächsten Überwachungsstation — plus globale Abdeckung über Open-Meteo. Verfolge mehrere Städte gleichzeitig.',
    ...
    'feat5.desc':  'Sieh dir typische Saisonfenster und Spitzenmonate für jeden Allergen im integrierten Leitfaden an — mit Quellenbezeichnungen (PIA oder EAN) pro Allergen und regionalen Daten, die eventuelle Lücken füllen.',
    ...
    'feat7.title': 'Die heutigen Bedingungen auf einen Blick',
    'feat7.desc':  'Eine ausklappbare Karte zeigt das Wetter und den EU-Luftqualitätsindex nebeneinander — Höchst-, Tiefstwert, Wind, Niederschlag und ein 6-Stufen-AQI-Balken, alles ohne die Vorhersage zu verlassen.',
    'feat8.title': 'Vorausplanen mit Zuversicht',
    'feat8.desc':  'Der Plan-Tab vereint zwei vorausschauende Werkzeuge an einem Ort: die beste Zeit zum Ausgehen heute (ein Stunden-für-Stunden-Allergendiagramm mit Wettersymbolen) und den Saisonkalender für jeden gespeicherten Standort.',
    'feat9.title': 'Versteh, warum die Werte hoch sind',
    'feat9.desc':  'Die App zeigt den Grund hinter dem heutigen Niveau — Regen im Anmarsch, trockene und windige Bedingungen oder ein saisonaler Höchstwert — damit du immer weißt, womit du es zu tun hast.',
    'feat10.title': 'Funktioniert offline',
    'feat10.desc':  'Die App zeigt deine letzte gespeicherte Vorhersage mit einem Zeitstempel an, wenn du die Verbindung verlierst.',
