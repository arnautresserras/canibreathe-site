const TRANSLATIONS = {
  ca: {
    ...
    'beta.label': 'Beta tancada · Android',
    'beta.step1.title': 'Uneix-te al grup de beta',
    'beta.step1.desc': 'Per ser inclòs a la llista d\'accés',
    'beta.step2.title': 'Activa la beta a Google Play',
    'beta.step2.desc': 'Per instal·lar la versió de prova',
    'beta.notice': 'L\'app encara no és al Play Store públic perquè Google l\'està revisant. Mentrestant, pots instal·lar-la a través de la beta tancada. Assegura\'t d\'usar el mateix compte de Google al grup i a Google Play.',
  ...
  en: {
    ...
    'beta.label': 'Closed Beta · Android',
    'beta.step1.title': 'Join the beta group',
    'beta.step1.desc': 'To get added to the access list',
    'beta.step2.title': 'Opt in on Google Play',
    'beta.step2.desc': 'To install the test build',
    'beta.notice': 'The app isn\'t on the public Play Store yet — Google is still reviewing it. In the meantime, you can install it through the closed beta. Make sure you use the same Google account in the group and on Google Play.',
  ...
  es: {
    ...
    'beta.label': 'Beta cerrada · Android',
    'beta.step1.title': 'Únete al grupo de beta',
    'beta.step1.desc': 'Para ser incluido en la lista de acceso',
    'beta.step2.title': 'Activa la beta en Google Play',
    'beta.step2.desc': 'Para instalar la versión de prueba',
    'beta.notice': 'La app todavía no está en el Play Store público porque Google la está revisando. Mientras tanto, puedes instalarla a través de la beta cerrada. Asegúrate de usar la misma cuenta de Google en el grupo y en Google Play.',
  ...
  fr: {
    ...
    'beta.label': 'Bêta fermée · Android',
    'beta.step1.title': 'Rejoindre le groupe bêta',
    'beta.step1.desc':  'Pour être ajouté à la liste d\'accès',
    'beta.step2.title': 'S\'inscrire sur Google Play',
    'beta.step2.desc':  'Pour installer la version de test',
    'beta.notice': 'L\'app n\'est pas encore sur le Play Store public — Google est en train de la réviser. En attendant, vous pouvez l\'installer via la bêta fermée. Utilisez le même compte Google dans le groupe et sur Google Play.',
  ...
  pt: {
    ...
    'beta.label': 'Beta fechada · Android',
    'beta.step1.title': 'Entrar no grupo beta',
    'beta.step1.desc':  'Para ser incluído na lista de acesso',
    'beta.step2.title': 'Ativar a beta no Google Play',
    'beta.step2.desc':  'Para instalar a versão de teste',
    'beta.notice': 'A app ainda não está na Play Store pública — a Google ainda está a revê-la. Entretanto, podes instalá-la através da beta fechada. Certifica-te de que usas a mesma conta Google no grupo e no Google Play.',
  ...
  it: {
    ...
    'beta.label': 'Beta chiusa · Android',
    'beta.step1.title': 'Unisciti al gruppo beta',
    'beta.step1.desc':  'Per essere aggiunto alla lista di accesso',
    'beta.step2.title': 'Iscriviti su Google Play',
    'beta.step2.desc':  'Per installare la versione di prova',
    'beta.notice': 'L\'app non è ancora sul Play Store pubblico — Google la sta ancora esaminando. Nel frattempo, puoi installarla tramite la beta chiusa. Assicurati di usare lo stesso account Google nel gruppo e su Google Play.',
  ...
  de: {
    ...
    'beta.label': 'Geschlossene Beta · Android',
    'beta.step1.title': 'Beta-Gruppe beitreten',
    'beta.step1.desc':  'Um zur Zugriffsliste hinzugefügt zu werden',
    'beta.step2.title': 'Beta auf Google Play aktivieren',
    'beta.step2.desc':  'Um die Testversion zu installieren',
    'beta.notice': 'Die App ist noch nicht im öffentlichen Play Store — Google prüft sie noch. In der Zwischenzeit kannst du sie über die geschlossene Beta installieren. Stell sicher, dass du dasselbe Google-Konto in der Gruppe und auf Google Play verwendest.',
